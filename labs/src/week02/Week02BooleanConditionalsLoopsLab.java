...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		double loyaltyMemberDiscount = 0.0d;
		switch(loyaltyMemberStatus) {
			case "SILVER":
				loyaltyMemberDiscount = 0.10d;
				break;
			case "GOLD":
				loyaltyMemberDiscount = 0.15d;
				break;
			case "PLATINUM":
				loyaltyMemberDiscount = 0.25d;
				break;
			default:
				loyaltyMemberDiscount = 0.0d;
				break;
		}
